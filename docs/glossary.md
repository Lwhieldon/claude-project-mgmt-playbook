...
A Markdown file in your project root that gives Claude persistent context about your engagement. Think of it as a briefing document that Claude re-reads at the start of every session — your communication standards, stakeholder map, artifact formats, and running project notes all live here.
...
Red / Amber / Green — a standard project health indicator used in consulting status reports.
