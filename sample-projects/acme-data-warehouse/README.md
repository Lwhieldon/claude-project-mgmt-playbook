...
- **Overall status:** 🟡 Amber; velocity is behind plan due to delayed UAT environment
...
|---|---|---|
| `sow.md` | Full Statement of Work covering scope, timeline, pricing, and risks | `/sow-review sow.md` |
...
1. **Start with the SOW review.** This flags missing acceptance criteria and change control gaps:
   ```
...
- The SOW uses vague acceptance language ("fully functional"). This is a real risk in fixed-price contracts.
- The meeting transcript has an action item buried in the middle of a long exchange that's easy to miss manually
- The status CSV shows budget burn accelerating in Weeks 9-10 while % complete stays flat, which is a warning sign worth flagging.
